...
-   **Difficulty-like** : influence both the mean and SD.
...
**μ** reflects **difficulty**, **λ** influence the **scale**. The larger **μ** and the smaller **λ**, the more variable the RTs: $\sigma = \sqrt{\frac{\mu^3}{\lambda}}$
:::
:::::
...
*Spoiler: [Racing Diffusion Model](https://link.springer.com/article/10.3758/s13423-020-01719-6)*

μ = threshold/drift

λ = (threshold\^2)/variance diffusion process
:::
:::::
...
Word vs. non-word, valid vs. invalid cue
